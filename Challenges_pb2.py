...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[RLWE__pb2.DESCRIPTOR,])
...
_INSTANCECONT.fields_by_name['samples'].message_type = RLWE__pb2._SAMPLECONT
_INSTANCEDISC.fields_by_name['params'].message_type = _DISCPARAMS
_INSTANCEDISC.fields_by_name['samples'].message_type = RLWE__pb2._SAMPLEDISC
_INSTANCERLWR.fields_by_name['params'].message_type = _RLWRPARAMS
_INSTANCERLWR.fields_by_name['samples'].message_type = RLWE__pb2._SAMPLERLWR
_SECRET.fields_by_name['s'].message_type = RLWE__pb2._RQ
